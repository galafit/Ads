...
class EndianBitConverter {
     ...
     * @param intArrayOffset      the calculateOffset within the int array of the first int to be converted
     * @param byteArray           byte array to write resultant bytes
     * @param byteArrayOffset     the calculateOffset within the byte array of the first byte to be written
